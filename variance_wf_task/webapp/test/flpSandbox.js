		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Action variance",
									"targetURL": "#aucomiesolpoconfirmationvariancewftask-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"aucomiesolpoconfirmationvariancewftask-display": {
								"semanticObject": "aucomiesolpoconfirmationvariancewftask",
								"action": "display",
								"description": "Action variance",
								"title": "Action variance",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=au.com.iesol.po.confirmation.variancewftask",
									"url": sap.ui.require.toUrl("au/com/iesol/po/confirmation/variancewftask")
								}
							}
						}
					}
